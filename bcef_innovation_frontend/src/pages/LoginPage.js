    ...
    return (
        <div className="login-admin-container">
            <div className="login-background">
                <div className="data-science-elements">
                    <div className="floating-node"></div>
                    <div className="floating-node"></div>
                    <div className="floating-node"></div>
                    <div className="network-line"></div>
                    <div className="network-line"></div>
                    <div className="binary-code">1010 0101 1100 0011</div>
                </div>
            </div>
            
            <form className="login-admin-form glassmorphism-card" onSubmit={handleLogin}>
                ...
                <button 
                    type="submit" 
                    className={`login-admin-btn ${isLoading ? 'loading' : ''}`}
                    disabled={isLoading}
                >
                    {isLoading ? (
                        <>
